...
export namespace ISLAND {
  ...
  export enum FATAL {
    ...
    F0005_NOT_IMPLEMENTED_ERROR               = 5,
    F0006_NOT_IMPLEMENTED_ERROR               = 6,
    F0007_NOT_IMPLEMENTED_ERROR               = 7,
    F0008_AMQP_CHANNEL_POOL_REQUIRED          = 8,
    F0009_AMQP_CHANNEL_POOL_REQUIRED          = 9,
    F0010_AMQP_CHANNEL_POOL_REQUIRED          = 10,
    F0011_NOT_INITIALIZED_EXCEPTION           = 11,
    F0012_ROUND_ROBIN_EVENT_Q_IS_NOT_DEFINED  = 12,
    F0013_NOT_INITIALIZED                     = 13,
    F0014_NOT_INITIALIZED                     = 14,
    F0015_TAG_IS_UNDEFINED                    = 15,
    F0016_SCOPE_CONTEXT_ERROR                 = 16,
    F0017_SCOPE_CONTEXT_ERROR                 = 17,
